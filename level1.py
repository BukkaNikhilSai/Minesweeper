...
class Minesweeper:
	def __init__(self,master):
		...
		for x in range(64):
			...
			if (random.uniform(0,1)<0.13): #computer chooses no.of mines randomly
				mine=1
	...
	def Quit(self):
	 	End=tkMessageBox.askquestion("Quit", "Are You want to exit level")
	        global root
